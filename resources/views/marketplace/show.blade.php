...
<form action="{{ route('marketplace.checkout.confirm', $product->id) }}" method="GET" class="w-[60%] flex m-0">
    <button type="submit" 
            class="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-sm flex items-center justify-center transition {{ $product->is_sold ? 'bg-gray-400 hover:bg-gray-400 cursor-not-allowed' : '' }}" 
