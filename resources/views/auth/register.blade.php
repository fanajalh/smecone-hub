    ...
    <div class="max-w-6xl w-full bg-white rounded-[2.5rem] shadow-2xl flex flex-col md:flex-row overflow-hidden min-h-[650px] border border-gray-100">
        ...
        <div class="hidden md:flex w-1/2 bg-red-50 relative p-12 flex-col justify-between illus-enter items-center overflow-hidden group">
                    ...
                    <div id="css-fallback" class="hidden absolute inset-0 flex-col items-center justify-center">
                        <div class="w-48 h-48 bg-white/80 rounded-3xl shadow-xl flex items-center justify-center relative rotate-3 hover:rotate-0 transition-transform duration-500 backdrop-blur-sm border border-white">
                            <div class="absolute inset-4 bg-red-50/50 rounded-2xl border-2 border-dashed border-red-200 flex items-center justify-center">
                                <svg class="w-16 h-16 text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"></path></svg>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="relative z-10 w-full mt-8 glass-card p-6 rounded-2xl text-left border border-white shadow-lg">
                <h3 class="font-bold text-gray-800 text-lg mb-2">Bergabung Sekarang</h3>
                <p class="text-sm text-gray-600 leading-relaxed">Jadilah bagian dari ekosistem digital Smecone dan nikmati berbagai kemudahan akses layanan terpadu kami.</p>
            </div>
        </div>
        ...
        <div class="w-full md:w-1/2 p-8 sm:p-12 lg:p-16 flex flex-col justify-center bg-white relative form-enter">
            ...
            <div class="text-left mb-8">
                <h1 class="text-3xl lg:text-4xl font-black text-gray-900 tracking-tight mb-2">Daftar Akun</h1>
                <p class="text-gray-500 font-medium">Buat akun untuk bergabung dengan Smecone Hub.</p>
            </div>

            @if ($errors->any())
                <div class="bg-red-50 text-red-700 p-4 rounded-xl mb-6 text-sm border border-red-200 font-semibold flex items-start gap-3 shadow-sm">
                    <svg class="w-5 h-5 flex-shrink-0 text-red-500 mt-0.5" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path></svg>
            ...
            <form action="/register" method="POST" class="space-y-4">
                ...
                <div class="space-y-1.5">
                    ...
                    <div class="relative group">
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name') }}" required placeholder="Masukkan nama lengkap"
                               class="w-full pl-11 pr-5 py-3.5 bg-[#f8f9fc] border border-gray-200 text-gray-900 rounded-2xl focus:outline-none focus:ring-2 focus:ring-red-500/20 focus:border-red-500 focus:bg-white transition-all">
                    </div>
                </div>
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="relative group">
                            ...
                            <input type="number" id="nis" name="nis" value="{{ old('nis') }}" required placeholder="NIS"
                                   class="w-full pl-11 pr-3 py-3.5 bg-[#f8f9fc] border border-gray-200 text-gray-900 rounded-2xl focus:outline-none focus:ring-2 focus:ring-red-500/20 focus:border-red-500 focus:bg-white transition-all">
                        </div>
                    </div>
                ...
                <div class="space-y-1.5">
                    ...
                    <div class="relative group">
                        ...
                        <input type="password" id="password" name="password" required placeholder="Masukkan password"
                               class="w-full pl-11 pr-12 py-3.5 bg-[#f8f9fc] border border-gray-200 text-gray-900 rounded-2xl focus:outline-none focus:ring-2 focus:ring-red-500/20 focus:border-red-500 focus:bg-white transition-all">
                        
                        <button type="button" onclick="togglePassword('password', 'eye-icon-pw')" class="absolute inset-y-0 right-0 flex items-center pr-4 text-gray-400 hover:text-gray-600 transition-colors">
                ...
                <div class="space-y-1.5">
                    ...
                    <div class="relative group">
                        ...
                        <button type="button" onclick="togglePassword('password_confirmation', 'eye-icon-conf')" class="absolute inset-y-0 right-0 flex items-center pr-4 text-gray-400 hover:text-gray-600 transition-colors">
                            <svg id="eye-icon-conf" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path></svg>
                        </button>
                    </div>
                </div>

                <div class="pt-2">
                    <button type="submit" class="w-full bg-red-500 text-white font-bold py-4 px-4 rounded-2xl hover:bg-red-600 hover:shadow-[0_8px_20px_rgba(239,68,68,0.3)] hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.98] transition-all flex justify-center items-center gap-2">
                        DAFTAR AKUN
